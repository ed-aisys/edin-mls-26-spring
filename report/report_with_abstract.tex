...
A notable consequence is that encoder attention (AI~$\sim$20--40) crosses the H200's ridge point and becomes compute-bound, unlike on consumer GPUs (ridge~$\approx$58.5) where it remains bandwidth-bound.  The H200 thus benefits more from larger tiles (128$\times$128) that increase compute utilization.
