...
\textbf{Result:} On the H200, disabling the SDPA fallback costs +3.4\,ms (Table~\ref{tab:ablation}), confirming the benefit of routing single-token decode to PyTorch's optimized path.
