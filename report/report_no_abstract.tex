...
\begin{table}[h]
\centering
\caption{H200 ablation: top-impact parameter changes (baseline: 205.2\,ms).  $^\dagger$Uses origin/main 3-kernel pipeline + stock $O(n^2)$ generation (no KV cache).}
\label{tab:ablation}
\small
\begin{tabular}{@{}lrrl@{}}
\toprule
...
\midrule
3-kernel attention$^\dagger$ & 1808.2 & +1603 & Flash attn 8.5$\times$ faster \\
